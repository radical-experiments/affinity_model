...
if sys.argv[1] == "stampede" or sys.argv[1] == "gordon" or sys.argv[1] == "comet" or sys.argv[1] == "supermic" or sys.argv[1] == "bridges":
    res = sys.argv[1]
    random.seed()
else:
    sys.exit()
...
for run in range(SAMPLE_SIZE):
    ...
    print "Sleeping for 5 minutes to see if that is enough between runs\n"
    time.sleep(300)

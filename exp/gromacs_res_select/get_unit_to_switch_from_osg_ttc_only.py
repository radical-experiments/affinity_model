...
if __name__ == "__main__":
    ...
    try:
        osg_bridges_move_units = get_units_larger_ttc(bridges_max_ttc_timestamp, unit_timings['osg'])
        print "Bridges"
    ...
    try:
        osg_comet_move_units = get_units_larger_ttc(comet_max_ttc_timestamp, unit_timings['osg'])
        print "Comet"
